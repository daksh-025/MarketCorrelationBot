...
def get_market_news(ticker="ETH-USD"):
...
# Example usage
btc_news = get_market_news("ETH-USD")
...
print(f"Overall ETH Market Sentiment: {sentimnentresult}")
send_telegram_message(f"Overall ETH Market Sentiment: {sentimnentresult}")