...
# Example usage
btc_news = get_market_news("BTC-USD")
...
print(f"Overall BTC Market Sentiment: {sentimnentresult}")
BTCsentiment=f"Overall BTC Market Sentiment: {sentimnentresult}"
send_telegram_message(BTCsentiment)